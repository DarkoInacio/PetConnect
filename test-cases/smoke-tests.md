# Smoke Tests — PetConnect

**Propósito:** Ejecutar estos 15 casos **antes de cada deploy** a staging o producción.  
**Tiempo estimado:** ~20 minutos (5 min API en Postman + 15 min UI manual).  
**Plan completo:** [TEST_PLAN.md](../TEST_PLAN.md)
...
Ver colección importable en [`postman/`](../postman/README.md).
